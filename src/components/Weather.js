...
const Weather = () => {
  ...
  return (
    <div className='w-[48rem] px-4 text-white'>
        <div className='mx-4 mt-6 flex justify-between bg-slate-900 opacity-60 rounded-lg p-2 hover:bg-black'>
        ...
        <div className='bg-slate-900 bg-opacity-60 rounded-lg ml-6 mt-4 w-98 p-6 hover:bg-black'>
            <div className='flex'>
